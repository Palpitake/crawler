...
from crawler_agent.core.common import safe_int as _safe_int
...
_COMPOUND_PUBLIC_SUFFIXES = {
    ...
    "com.cn", "com.hk", "com.mx", "com.sg", "com.tw", "gov.uk",
    "net.au", "net.cn", "org.au", "org.cn", "org.uk",
}
...
def site_family(domain: str) -> str:
    """Return a conservative registrable-site approximation.

    RAG uses this only as a site boundary, never as a security boundary.  It
    joins ordinary service subdomains such as ``www`` and ``edith`` while
    preserving common compound public suffixes such as ``com.cn``.
    """
