...
BROWSER_PIPELINE_BUILD = f"{BUILD_DATE}-browser-pi-agent-core-native-v{VERSION}"
...
def run_browser_pipeline(
    ...
    from crawler_agent.pipelines.browser_agent_pipeline import (
        run_browser_agent_pipeline,
    )
